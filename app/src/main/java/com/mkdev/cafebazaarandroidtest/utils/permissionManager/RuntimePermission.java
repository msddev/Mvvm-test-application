...
import com.mkdev.cafebazaarandroidtest.utils.permissionManager.callbacks.AcceptedCallback;
import com.mkdev.cafebazaarandroidtest.utils.permissionManager.callbacks.DeniedCallback;
import com.mkdev.cafebazaarandroidtest.utils.permissionManager.callbacks.ForeverDeniedCallback;
import com.mkdev.cafebazaarandroidtest.utils.permissionManager.callbacks.PermissionListener;
import com.mkdev.cafebazaarandroidtest.utils.permissionManager.callbacks.ResponseCallback;
...
public class RuntimePermission {
    ...
    private final PermissionFragment.PermissionListener listener =
            new PermissionFragment.PermissionListener() {
                @Override
     ...
     */
    public static RuntimePermission askPermission(
            @Nullable final FragmentActivity activity,
            String... permissions
    ) {
    ...
    public void ask() {
        ...
        if (permissions.isEmpty() ||
                ...
                arePermissionsAlreadyAccepted(activity, permissions)
        ) {
    ...
    private boolean arePermissionsAlreadyAccepted(
